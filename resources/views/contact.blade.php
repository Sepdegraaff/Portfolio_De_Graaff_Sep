...
@section('content')
    ...
    <section class="pb-[250px] px-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="flex flex-col gap-4 items-center hidden-animation transition-all duration-700">
            <img class="object-contain w-full max-w-[500px]" src="{{ asset('images/Profile_Picture.png') }}" alt="face">
        </div>
