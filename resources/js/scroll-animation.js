document.addEventListener("DOMContentLoaded", () => {
    const sections = [
        ...
        {
            sectionSelector: "#scroll-section-8",
            elementSelector: ".scale-up-on-scroll-8",
            scaleStart: 1,
            scaleEnd: 2,
            startScrollOffset: 0,
            endScrollOffset: 0,
        ...
        {
            sectionSelector: "#scroll-section-9",
            elementSelector: ".scale-up-on-scroll-9",
            scaleStart: 1,
            scaleEnd: 5,
            startScrollOffset: 0,
            endScrollOffset: 0,
        ...
        {
            sectionSelector: "#scroll-section-10",
            elementSelector: ".scale-up-on-scroll-10",
            scaleStart: 1,
            scaleEnd: 5,
            startScrollOffset: 0,
            endScrollOffset: 0,
        ...
        {
            sectionSelector: "#scroll-section-11",
            elementSelector: ".scale-up-on-scroll-11",
            scaleStart: 1,
            scaleEnd: 5,
            startScrollOffset: 0,
            endScrollOffset: 0,
        ...
        {
            sectionSelector: "#scroll-section-12",
            elementSelector: ".scale-up-on-scroll-12",
            scaleStart: 1,
            scaleEnd: 5,
            startScrollOffset: 0,
            endScrollOffset: 0,
